...
#Instantiate C++ class. 
engine = my_Standarization.Standarization(test_data)

#Call the C++ calculate method
standardized_output = engine.calculate()
for val in standardized_output:
    print(val)

print(f"\nSuccessfully processed {len(standardized_output)} elements!")
